...
def createInputJson(output_file, 
                    ...
                    event_ex_param_str = '',
                    # tPrime_im_ex_list = 'SY=0,384,6,500', ######## FLAG
                    tPrime_im_ex_list = '',
                    # tPrime_ni_ex_list = 'XA=0,1,3,500', ######## FLAG
                    tPrime_ni_ex_list = '',
                    sync_period = 1.0,
                    # toStream_sync_params = 'SY=0,384,6,500',  ######## FLAG
                    toStream_sync_params = '',
                    # niStream_sync_params = 'XA=0,1,3,500',  ######## FLAG
    ...
    # update 3/9/24: revert to using KS3 (non-patched)
    # kilosort_repository = r'\\oak-smb-giocomo.stanford.edu\groups\giocomo\fcho2\ecephys_localtools\KilosortLocal'
    # update 10/22/24
    # kilosort_repository = r'C:\Users\walnut\Documents\GitHub\Kilosort'
    kilosort_repository = r'C:\Users\walnut\Documents\Kilosort-3.0.2'
    print('USING KILOSORT VERSION 3.0.2 (PATCHED 4/8/24)')
