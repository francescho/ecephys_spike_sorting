...
def createInputJson(output_file, 
    ...
    ecephys_directory = r'/home/users/fcho/ecephys_spike_sorting/ecephys_spike_sorting' # github repo
    ...
    # kilosort_output_tmp = os.environ.get("KEY_FROM_SBATCH_ENV_VAR", default_ks_tmp) # if first doesn't exist, it will save to default (do this if running serial)


     
    # for config files and kilosort working space
    kilosort_output_tmp = r'/oak/stanford/groups/giocomo/fcho/ecephys_localtools/Kilosort_scratch' 
