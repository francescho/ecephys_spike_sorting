...
def runOne( session_id,
    ...
    if run_CatGT:
        command = sys.executable + " -W ignore -m ecephys_spike_sorting.modules." + 'catGT_helper' + " --input_json " + shlex.quote(catGT_input_json) \
		          + " --output_json " + shlex.quote(catGT_output_json)
        print(command)
    ...
    for module in modules:
        ...
        command = sys.executable + " -W ignore -m ecephys_spike_sorting.modules." + module + " --input_json " + shlex.quote(module_input_json) \
